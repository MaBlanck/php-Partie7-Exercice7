...
if($_FILES)
{
    ...
    if (isset($_FILES['myFile']) && $_FILES['myFile']['error'] == 1) 
    {      //test si le fichier n'est pas trop gros
        if ($_FILES['myFile']['size'] <= 1000000) 
        {   //on récupère l'extension et son le nom du fichier grâce à la fonction pathinfo() qu'on stocke dans extension_upload
